...
pub mod functions {
    ...
    impl Burn {
        const METHOD_ID: [u8; 4] = [152u8, 240u8, 111u8, 44u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl Immutables {
        const METHOD_ID: [u8; 4] = [253u8, 245u8, 54u8, 101u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for Immutables {
        const NAME: &'static str = "immutables";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct LockedBalanceOf {
        pub account: Vec<u8>,
    }
    impl LockedBalanceOf {
        const METHOD_ID: [u8; 4] = [89u8, 53u8, 87u8, 54u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for LockedBalanceOf {
        const NAME: &'static str = "lockedBalanceOf";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl Mint {
        const METHOD_ID: [u8; 4] = [134u8, 120u8, 16u8, 47u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ...
                    ethabi::Token::Bool(self.partial_fill_allowed.clone()),
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
                            match self.deadline.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
    ...
    impl MintState {
        const METHOD_ID: [u8; 4] = [192u8, 81u8, 227u8, 138u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for MintState {
        const NAME: &'static str = "mintState";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<[u8; 32usize]> for Nonce {
    ...
    pub struct SwapMint {
        ...
        pub receiver: Vec<u8>,
        pub input_token_index: substreams::scalar::BigInt,
        pub lp_amount_out: substreams::scalar::BigInt,
        pub max_amount_in: substreams::scalar::BigInt,
        pub min_lp_out: substreams::scalar::BigInt,
        pub partial_fill_allowed: bool,
        pub deadline: substreams::scalar::BigInt,
    ...
    impl SwapMint {
        const METHOD_ID: [u8; 4] = [130u8, 88u8, 168u8, 86u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ...
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
                            match self.lp_amount_out.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                    panic!("negative numbers are not supported")
...
pub mod events {
    ...
    impl substreams_ethereum::Event for GuardianChanged {
        const NAME: &'static str = "GuardianChanged";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
    ...
    pub struct Mint {
        ...
        pub gamma_requested: substreams::scalar::BigInt,
        pub gamma_filled: substreams::scalar::BigInt,
    }
    impl Mint {
        const TOPIC_ID: [u8; 32] = [
            232u8,
