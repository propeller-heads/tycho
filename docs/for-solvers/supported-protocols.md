...
For venues that price off the chain — the RFQ market makers and the off-chain-priced pAMMs, whose books arrive over a WebSocket or an API — see [Off-Chain Priced Venues](request-for-quote-protocols.md).
