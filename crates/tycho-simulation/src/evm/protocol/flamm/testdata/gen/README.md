...
`fetch.py`. `out/` is the scripts' working tree and is not committed; the committed fixtures are
byte-for-byte what `package.py` and `pack.py` write from it, and the digests in the READMEs and in
`tests/fixtures.rs` pin them.
...
| `grids.py` | `d49f228a697a115f9a90a65e761b6b08b8f9d9f563c5e191c05338af0c4d3a77` |
...
| `fetch.py` | `05772d9ba5e47a5f5daaa9597a99742c8ad017cf03d043fe329523582daf9969` |
