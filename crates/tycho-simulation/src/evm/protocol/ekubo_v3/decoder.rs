...
use super::{
    addresses::{
        is_signed_exclusive_swap, BOOSTED_FEES_CONCENTRATED_ADDRESS, MEV_CAPTURE_ADDRESS,
        ORACLE_ADDRESS, TWAMM_ADDRESS_V1, TWAMM_ADDRESS_V2, VE33_ROBINHOOD_ADDRESS,
    },
...
pub fn extension_type(extension: Address, chain: Chain) -> Option<ExtensionType> {
    ...
    } else if is_signed_exclusive_swap(extension) {
