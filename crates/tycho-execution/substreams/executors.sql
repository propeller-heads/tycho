...
INSERT INTO executors (chain, address, protocol_systems) VALUES
    ...
    ('arbitrum', '0xce5af637bffe0c34a37f34471ab6a3e90adf8ffb', ARRAY['book:metric']),
    ...
    ('base', '0xb8644a264a4b765e60c4a65fb8049eae1a791d97', ARRAY['book:metric']),
    ('base', '0xbf9b925b6f5f6a5919f70e62d56403948f27f882', ARRAY['pancakeswap_v3', 'uniswap_v3']),
    ('base', '0xbfb5fbfd4c4182d3a1df91ced45335c543bed3f0', ARRAY['book:bebop']),
    ('base', '0xcdf4e28676b9f2e8c6a722eb163e0c2f9c0716b7', ARRAY['book:bebop']),
    ...
    ('base', '0xf35839c54a33fe88867acb3deac9db3adb9bfa78', ARRAY['book:bebop']),
    ...
    ('bsc', '0x8a61866f7f9c979bee4426247e144add46cd21aa', ARRAY['book:metric']),
    ...
    ('ethereum', '0x1f6ecc09b7753b1f637ed702ade44b5ba034dd5a', ARRAY['book:bebop']),
    ...
    ('ethereum', '0x3bd39a3606b9dc0afd07ea1c865c4583d94cba60', ARRAY['book:liquorice']),
    ...
    ('ethereum', '0x69eae6eb2c924567912fbc435b915663c9d3d11e', ARRAY['book:bebop']),
    ...
    ('ethereum', '0x81c7febeed3fd67a5fdcf892d43489091caeb186', ARRAY['book:liquorice']),
    ...
    ('ethereum', '0x93fc40cd88b54f2cbcbf182fa1c78522805b213a', ARRAY['book:hashflow']),
    ...
    ('ethereum', '0xac51c531555b7154fe1bcb7cf4508e93a3beda75', ARRAY['book:liquorice']),
    ...
    ('ethereum', '0xbc7c1e078865bb81938adddf24582eedd17324c7', ARRAY['book:hashflow']),
    ...
    ('ethereum', '0xd74644f4ed013dc5f63fe2a576e5fbf6070aec00', ARRAY['book:bebop']),
    ('ethereum', '0xd95d619fa709ba559d9cee7645c5f71dbcf19f0f', ARRAY['book:metric']),
    ...
    ('polygon', '0x746cdaf8ef08a9d023155dddc95291ab8c9a7936', ARRAY['book:metric']),
