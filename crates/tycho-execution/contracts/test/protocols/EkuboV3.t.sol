...
contract EkuboV3EthereumExecutorStandalone is
    EkuboV3EthereumExecutor,
    EkuboV3StandaloneBase
{
    ...
    function _swapHop(
        ...
        internal
        override(EkuboV3ExecutorBase, EkuboV3EthereumExecutor)
    ...
    function _hopEnd(bytes calldata data, uint256 offset, PoolConfig poolConfig)
        ...
        returns (uint256)
    {
        return super._hopEnd(data, offset, poolConfig);
    }
}
    ...
    EkuboV3StandaloneBase
{
    ...
    function _swapHop(
        ...
        internal
        override(EkuboV3ExecutorBase, EkuboV3RobinhoodExecutor)
        returns (PoolBalanceUpdate, uint256)
    {
        return super._swapHop(poolKey, swapParameters, swapData, offset);
    }
...
contract EkuboV3ExecutorTest is Constants, TestUtils {
    EkuboV3EthereumExecutorStandalone immutable executor =
        new EkuboV3EthereumExecutorStandalone();
